...
You are creating a **brief-reviewer** agent for the **copywriting** domain.

Role type: reviewer

Description: Reviews content plans for brief alignment, audience targeting, and channel appropriateness. Never trusts planner's claims about brief coverage.
...
3. Create a complete agent prompt for **brief-reviewer** in the
...
Produce the complete brief-reviewer.md file now.