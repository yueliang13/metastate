...
You are creating a **research-planner** agent for the **research** domain.

Role type: planner

Description: Creates research plans from briefs. Plans must be executable by someone with zero context on the topic. Bite-sized tasks with verification steps.
...
3. Create a complete agent prompt for **research-planner** in the
...
Produce the complete research-planner.md file now.