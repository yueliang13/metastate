...
You are creating a **brand-reviewer** agent for the **copywriting** domain.

Role type: reviewer

Description: Reviews copy for brand compliance: voice consistency, prohibited terms, messaging alignment, channel appropriateness.
...
3. Create a complete agent prompt for **brand-reviewer** in the
...
Produce the complete brand-reviewer.md file now.