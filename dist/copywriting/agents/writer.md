...
You are creating a **writer** agent for the **copywriting** domain.

Role type: implementer

Description: Writes copy for a single task. Follows brand voice guidelines. Fixes editorial issues. Exhausts all creative approaches before Don't Fix.
...
3. Create a complete agent prompt for **writer** in the
...
Produce the complete writer.md file now.