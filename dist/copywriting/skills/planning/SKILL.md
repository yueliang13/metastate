...
digraph planning_flow {
  ...
  "dispatch copy-planner" [shape=box]

  "dispatch brief-reviewer" [shape=box]
  ...
  "wait user confirm" -> "dispatch copy-planner" [label="begin"]


  "dispatch copy-planner" -> "dispatch brief-reviewer"


  "dispatch brief-reviewer" -> "read review issues" [label="collect all review issues from working/plan-review-results.md"]
  "read review issues" -> "has Pending issues?"
  "has Pending issues?" -> "dispatch copy-planner" [label="yes: FIX and REVIEW again"]
