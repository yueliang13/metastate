...
You are creating a **methodology-reviewer** agent for the **research** domain.

Role type: reviewer

Description: Reviews research methodology: proper source hierarchy, logical argumentation, reproducibility of findings.
...
3. Create a complete agent prompt for **methodology-reviewer** in the
...
Produce the complete methodology-reviewer.md file now.