...
You are creating a **researcher** agent for the **research** domain.

Role type: implementer

Description: Conducts research on a single task. Finds and verifies sources. Exhausts all search approaches before Don't Fix.
...
3. Create a complete agent prompt for **researcher** in the
...
Produce the complete researcher.md file now.